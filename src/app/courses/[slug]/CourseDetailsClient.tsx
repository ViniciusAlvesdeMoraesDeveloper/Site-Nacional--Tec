  ...
  return (
    <div className=" flex flex-col items-center justify-center p-8 bg-gradient-to-r from-green-900 transition-colors duration-1000 w-full">
      ...
      <div className="max-w-4xl w-full bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden transform transition-all hover:scale-[1.01]">
        ...
        <div className="p-8">
          ...
          <div className="mt-8 pt-4 border-t border-gray-200 dark:border-gray-700">
            {/* Adicione mais detalhes do curso aqui, como módulos, professores, etc. */}
          </div>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-balck">Inscrição para o curso</h2>
