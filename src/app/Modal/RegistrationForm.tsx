...
export default function RegistrationForm() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="p-4 space-y-6">
      ...
      <div>
        <label htmlFor="courseOfInterest" className="block text-sm font-medium text-gray-700">Curso de Interesse</label>
        <select
          id="courseOfInterest" name="courseOfInterest" value={formData.courseOfInterest} onChange={handleChange} required
